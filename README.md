...
*   **Shared API**: A common API module ensures consistency between the two persistence implementations.
...
*   `persistence-common-api`: A shared module containing common DTOs, interfaces, and validation logic.
